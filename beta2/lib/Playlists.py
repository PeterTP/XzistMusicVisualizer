...
class Playlists:
    ...
    def create_dock(self):
        ...
        playlists_list.clicked.connect(select)
        ...
        playlist_buttons_layout.setContentsMargins(20,0,20,0)

        add_button = QPushButton()
        add_button_icon = QPixmap(f"{self.PATH}/res/images/plus-1513-minimalui-white.webp")
        ...
        remove_button_icon = QPixmap(f"{self.PATH}/res/images/delete-1487-minimalui-white.webp")
        remove_button.setIcon(remove_button_icon)
        remove_button.clicked.connect(remove)
        playlist_buttons_layout.addWidget(remove_button)

        edit_button = QPushButton()
        edit_button_icon = QPixmap(f"{self.PATH}/res/images/edit-1479-minimalui-white.webp")
        ...
        path_button.clicked.connect(select_path)
        ...
        download_button.clicked.connect(init_download)
